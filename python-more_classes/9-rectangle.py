#!/usr/bin/python3
"""Bu modul kvadrat yaradan klas metodu olan Rectangle klasını təyin edir."""
...
class Rectangle:
    ...
    def square(cls, size=0):
        """Eni və hündürlüyü bərabər olan yeni Rectangle (kvadrat) qaytarır.

        Args:
            size (int): Kvadratın tərəfi.
        Returns:
            Yeni bir Rectangle instansiyası.
        """
